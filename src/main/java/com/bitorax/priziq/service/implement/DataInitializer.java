...
public class DataInitializer implements ApplicationRunner {
        ...
        private List<Permission> getDefaultPermissions() {
                return List.of(
                                ...
                                // Module Users
                                new Permission("Cập nhật thông tin tài khoản người dùng",
                                                "/api/v1/users/update-profile", "PATCH",
                                                "USERS"),
                                new Permission("Cập nhật mật khẩu mới tài khoản người dùng",
                                                "/api/v1/users/update-password", "PUT",
                                                "USERS"),
                                new Permission("Cập nhật email mới tài khoản người dùng", "/api/v1/users/update-email",
                                                "PUT", "USERS"),
                                new Permission("Xác thực và cập nhật email mới tài khoản người dùng",
                                                "/api/v1/users/verify-change-email", "POST", "USERS"),
                                new Permission("Lấy thông tin tài khoản một người dùng", "/api/v1/users/{id}", "GET",
                                                "USERS"),
                                new Permission("Lấy thông tin tài khoản tất cả người dùng với điều kiện truy vấn",
                                                "/api/v1/users",
                                                "GET", "USERS"),
                                new Permission("Cập nhật thông tin tài khoản người dùng (dành cho admin)",
                                                "/api/v1/users/{id}",
                                                "PATCH", "USERS"),
                                ...
                                new Permission("Cập nhật thông tin một vai trò (bao gồm thêm quyền hạn vào vai trò)",
                                                "/api/v1/roles/{id}", "PATCH", "ROLES"),
                                new Permission("Lấy thông tin một vai trò", "/api/v1/roles/{id}", "GET", "ROLES"),
                                new Permission("Lấy thông tin tất cả vai trò với điều kiện truy vấn", "/api/v1/roles",
                                                "GET", "ROLES"),
                                new Permission("Xóa quyền hạn khỏi một vai trò", "/api/v1/roles/{id}/permissions",
                                                "DELETE", "ROLES"),
                                new Permission("Xóa một vai trò", "/api/v1/roles/{id}", "DELETE", "ROLES"),

                                // Module Permissions
                                new Permission("Tạo mới một module", "/api/v1/permissions/module", "POST",
                                                "PERMISSIONS"),
                                new Permission("Xóa một module theo tên", "/api/v1/permissions/module/{name}", "DELETE",
                                                "PERMISSIONS"),
                                new Permission("Lấy thông tin tất cả tên module", "/api/v1/permissions/modules", "GET",
                                                "PERMISSIONS"),
                                new Permission("Tạo mới một quyền hạn", "/api/v1/permissions", "POST", "PERMISSIONS"),
                                new Permission("Cập nhật thông tin một quyền hạn", "/api/v1/permissions/{id}", "PATCH",
                                                "PERMISSIONS"),
                                new Permission("Lấy thông tin một quyền hạn", "/api/v1/permissions/{id}", "GET",
                                                "PERMISSIONS"),
                                new Permission("Lấy thông tin tất cả quyền hạn với điều kiện truy vấn",
                                                "/api/v1/permissions", "GET",
                                                "PERMISSIONS"),
                                new Permission("Xóa một quyền hạn", "/api/v1/permissions/{id}", "DELETE",
                                                "PERMISSIONS"),

                                // Module Files (AWS S3)
                                new Permission("Tải lên một file lên AWS S3", "/api/v1/storage/aws-s3/upload/single",
                                                "POST", "FILES"),
                                new Permission("Tải lên nhiều file lên AWS S3",
                                                "/api/v1/storage/aws-s3/upload/multiple", "POST",
                                                "FILES"),
                                new Permission("Xóa một file trên AWS S3", "/api/v1/storage/aws-s3/delete/single",
                                                "DELETE", "FILES"),
                                new Permission("Xóa nhiều file trên AWS S3", "/api/v1/storage/aws-s3/upload/multiple",
                                                "DELETE",
                                                "FILES"),
                                new Permission("Di chuyển một file từ một thư mục sang một thư mục mới",
                                                "/api/v1/storage/aws-s3/move/single", "PUT", "FILES"),
                                new Permission("Di chuyển nhiều file từ nhiều thư mục sang một thư mục mới",
        ...
        private Map<RoleType, List<Permission>> getDefaultRoles() {
                ...
                List<Permission> adminRolePermissions = combinePermissions(
                                List.of(moduleAuthAllPermissions, moduleUserAllPermissions, moduleRoleAllPermissions,
                ...
                List<Permission> userRolePermissions = combinePermissions(
                                List.of(moduleAuthAllPermissions, userSpecificPermissions));

                // Permissions for role seller
                List<Permission> sellerRolePermissions = new ArrayList<>(userRolePermissions);

                // Permissions for role shipper
                List<Permission> shipperRolePermissions = new ArrayList<>(userRolePermissions);
